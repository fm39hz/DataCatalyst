namespace UniversalDataDriven.Plugins.Literals;
...
[UddsgPlugin(typeof(ITemplateLiteralRule))]
internal sealed class EnumTemplateLiteralRule : ITemplateLiteralRule {
	[ModuleInitializer]
	internal static void Register() => UddsgPluginRegistry.Register(new EnumTemplateLiteralRule());
