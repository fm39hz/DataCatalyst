...
/// <summary>
///     A single property or field on the optional <c>TemplateType</c> declared in <c>[GenerateFromData]</c>.
...
/// <summary>Read-only view of a UDDSG target's optional template type.</summary>
