...
/// <summary>
///     Read-only context passed to every plugin during a single UDDSG generation. Plugins use this to:
///     <list type="bullet">
...
///     </para>
/// </summary>
public sealed class UddsgGenerationContext {
