...
internal sealed class SourceEmitter {
    ...
    public string ConceptRef(string name) => _conceptNsMap.TryGetValue(name, out var ns)
        ...
        : $"global::DataCatalyst.Generated.{Helpers.Sanitize(name)}";
    ...
    public void EmitDeserializerHelpers(
        ...
        writer.Line("// <auto-generated/>");
        writer.Block("namespace DataCatalyst.Generated");
        writer.Block("public static class DataCatalystRegistries");
        ...
        writer.Block("public static void Populate(global::DataCatalyst.Registry.RegistrySet registries)");
        ...
        foreach (var kv in _beingConcepts) {
            ...
            writer.Line($"registries.Beings.Register<global::DataCatalyst.Generated.{en}>({typeArgs});");
        }
    ...
    public void EmitBeingStructs(
        ...
        foreach (var kv in _beingConcepts) {
            ...
            if (string.IsNullOrEmpty(ifaces))
                ...
                writer.Line($"public record struct {en} : global::DataCatalyst.IBeing, {ifaces} {{ }}");
        }
        writer.EndBlock();
    }
    ...
    public void EmitPools(
        ...
        foreach (var kv in _conceptAspects) {
            ...
            writer.Block($"public sealed class {cn}Pool : global::DataCatalyst.Storage.IStoragePool");
